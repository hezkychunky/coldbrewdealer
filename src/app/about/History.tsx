...
export default function History() {
   return(
      <div className="pt-36 h-auto sm:h-screen px-16 flex flex-col items-center gap-12 bg-lime-600">
         ...
         <br/>
         <br/>
         Fast-forward to 2021, and we're all moved into our new 15,000 sq. ft. brewery in the Bronx. It is a wonderland of stainless steel tanks and machinery that will allow the company to maintain premium quality, while growing in volume.
         <br/>
         <br/>
         We're thrilled to have you along for the ride and will continue to produce a product that Coldbrew Dealer is proud to put his name on.
         </p>
      </div>
   )
}